...
const fs = global.nodemodule["fs-extra"];
 ...
 var callback = () =>   api.sendMessage({body:`=== [ 𝗨𝗦𝗘𝗥 𝗜𝗗 ] ====\n━━━━━━━━━━━━━━━━━━\n[ ➤ ]➜ 𝗨𝗜𝗗: ${uid}\n[ ☣︎ ]➜ 𝗜𝗗: m.me/${uid}\n[ ☄︎ ]➜ 𝗟𝗶𝗻𝗸𝗳𝗯: https://www.facebook.com/profile.php?id=${uid}\n━━━━━━━━━━━━━━━━━━`, attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID,
...
var name = res.data.result.name 
				var callback = () =>  api.sendMessage({body:`=== [ 𝗨𝗦𝗘𝗥 𝗜𝗗 ] ====\n━━━━━━━━━━━━━━━━━━\n[ ➤ ]➜ 𝗨𝗜𝗗: ${event.senderID}\n[ ☣︎ ]➜ 𝗜𝗗: m.me/${event.senderID}\n[ ☄︎ ]➜ 𝗟𝗶𝗻𝗸𝗳𝗯: https://www.facebook.com/profile.php?id=${event.senderID}\n━━━━━━━━━━━━━━━━━━`, attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID,
				() => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID); 
